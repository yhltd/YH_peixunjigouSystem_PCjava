...
<section class="publicMian ">
    ...
    <div class="right">
        <div class="location">
            ...
            <span>教师课时统计  >> 信息增加页面</span>
        </div>
        <div class="providerAdd">
            <form action="<%=request.getContextPath() %>/teacher/add.action">
                <div>
...
<script>
    ...
    setTimeout(function(){
        var link = document.querySelector('.list a[href*="/keshi/getTeacherKeshiList.action"]');
        if (link) {
