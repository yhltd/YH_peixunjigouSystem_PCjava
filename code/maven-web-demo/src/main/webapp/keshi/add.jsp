...
<section class="publicMian ">
    ...
    <div class="right">
        <div class="location">
            ...
            <span>学生信息登记表 >> 新增课时明细</span>
        </div>
        <div class="providerAdd">
            <form action="<%=request.getContextPath() %>/keshi/add.action">
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="keshi" id="keshi"/>
                </div>
                <div>
                ...
                <div>
                    <label for="jine">每节课时金额：</label>
                    <input type="number" name="jine" id="jine"/>
                </div>
