...
<header class="publicHeader" id="navbar">
    ...
    <div class="publicHeaderR">
        ...
        <a style="box-sizing: border-box;width:80px;" onclick="shujv()">数据空间</a>
        <a style="box-sizing: border-box;" href="<%=request.getContextPath() %>/login.jsp" style="width:80px">退出</a>
    </div>
