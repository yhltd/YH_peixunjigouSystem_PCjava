...
<header class="publicHeader">
    ...
    <div class="publicHeaderR">
        <p><span id="hours"></span><span style="color: #fff21b"><img src="img/yyh.png" style="width: 14px;height: 14px">${GLOBAL_USER.realName} </span> , 欢迎你！</p>
...
<section class="publicMian">
    ...
    <div class="right">
        <div class="wFont">
            <div id="min3">
                <span ><a href="<%=request.getContextPath() %>/stu/student.action" >学生信息</a></span>
