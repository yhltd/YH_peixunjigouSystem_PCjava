...
<header class="publicHeader" id="navbar">
    ...
    <div class="publicHeaderR">
        ...
        <a style="background: url(../img/数据空间.png);box-sizing: border-box; onclick="shujv()" style="width:80px">数据空间</a>
        <a style="background: url(../img/退出.png);box-sizing: border-box;" href="<%=request.getContextPath() %>/login.jsp" style="width:80px">退出</a>
    </div>
