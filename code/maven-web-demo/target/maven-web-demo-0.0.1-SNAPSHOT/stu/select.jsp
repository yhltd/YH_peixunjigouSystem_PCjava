        ...
        <div class="providerAdd">
            <form action="<%=request.getContextPath() %>/stu/update.action">
                ...
                <div class="providerAddBtn" style="position: relative">
                    <input type="button" style="position: absolute;left: 100px; top: 0;" value="返回" onclick="history.back(-1)"/>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    ...
    setTimeout(function(){
        var link = document.querySelector('.list a[href*="stu"]');
        if (link) {
